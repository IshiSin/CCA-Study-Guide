...
export const metadata = {
  title: "Failure Recovery — CCA Study Guide",
}

export default async function FailureRecoveryPage() {
  const mdx = getMdxContent("domain-1/failure-recovery")
  if (!mdx) notFound()
  ...
  return (
    <TopicLayout
      ...
      prev={{ title: "Session & State Management", href: "/study/domain-1/session-state" }}
      next={{ title: "Anti-Patterns", href: "/study/domain-1/anti-patterns" }}
    >
      {content}
    </TopicLayout>
  )
