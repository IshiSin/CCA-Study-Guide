...
export const metadata = {
  title: "Context Degradation — CCA Study Guide",
}

export default async function ContextDegradationPage() {
  const mdx = getMdxContent("domain-5/context-degradation")
  if (!mdx) notFound()
  ...
  return (
    <TopicLayout
      ...
      prev={{ title: "Context Window", href: "/study/domain-5/context-window" }}
      next={{ title: "Escalation Design", href: "/study/domain-5/escalation-design" }}
    >
      {content}
    </TopicLayout>
  )
