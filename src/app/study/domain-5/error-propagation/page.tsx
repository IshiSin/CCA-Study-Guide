...
export const metadata = {
  title: "Error Propagation — CCA Study Guide",
}

export default async function ErrorPropagationPage() {
  const mdx = getMdxContent("domain-5/error-propagation")
  if (!mdx) notFound()
  ...
  return (
    <TopicLayout
      ...
      prev={{ title: "Human-in-the-Loop", href: "/study/domain-5/human-in-the-loop" }}
