...
export const metadata = {
  title: "Escalation Design — CCA Study Guide",
}

export default async function EscalationDesignPage() {
  const mdx = getMdxContent("domain-5/escalation-design")
  if (!mdx) notFound()
  ...
  return (
    <TopicLayout
      ...
      prev={{ title: "Context Degradation", href: "/study/domain-5/context-degradation" }}
      next={{ title: "Human-in-the-Loop", href: "/study/domain-5/human-in-the-loop" }}
    >
      {content}
    </TopicLayout>
  )
