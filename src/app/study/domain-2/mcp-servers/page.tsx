...
export const metadata = {
  title: "MCP Servers — CCA Study Guide",
}

export default async function McpServersPage() {
  const mdx = getMdxContent("domain-2/mcp-servers")
  if (!mdx) notFound()
  ...
  return (
    <TopicLayout
      ...
      prev={{ title: "Tool Descriptions", href: "/study/domain-2/tool-descriptions" }}
      next={{ title: "MCP Clients", href: "/study/domain-2/mcp-clients" }}
    >
      {content}
    </TopicLayout>
  )
