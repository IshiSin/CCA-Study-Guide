...
export const metadata = {
  title: "CI/CD Integration — CCA Study Guide",
}

export default async function CiCdIntegrationPage() {
  const mdx = getMdxContent("domain-3/ci-cd-integration")
  if (!mdx) notFound()
  ...
  return (
    <TopicLayout
      ...
      prev={{ title: "Plan Mode", href: "/study/domain-3/plan-mode" }}
      next={{ title: "MCP Configuration", href: "/study/domain-3/mcp-config" }}
    >
      {content}
    </TopicLayout>
  )
