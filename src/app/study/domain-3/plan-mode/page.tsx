...
export const metadata = {
  title: "Plan Mode — CCA Study Guide",
}

export default async function PlanModePage() {
  const mdx = getMdxContent("domain-3/plan-mode")
  if (!mdx) notFound()
  ...
  return (
    <TopicLayout
      ...
      prev={{ title: "Agent Skills", href: "/study/domain-3/agent-skills" }}
      next={{ title: "CI/CD Integration", href: "/study/domain-3/ci-cd-integration" }}
    >
      {content}
    </TopicLayout>
  )
