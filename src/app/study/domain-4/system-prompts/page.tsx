...
export const metadata = {
  title: "System Prompts — CCA Study Guide",
}

export default async function SystemPromptsPage() {
  const mdx = getMdxContent("domain-4/system-prompts")
  if (!mdx) notFound()
  ...
  return (
    <TopicLayout
      ...
      prev={{ title: "Domain 4 Overview", href: "/study/domain-4" }}
      next={{ title: "Few-Shot Prompting", href: "/study/domain-4/few-shot-prompting" }}
    >
      {content}
    </TopicLayout>
  )
