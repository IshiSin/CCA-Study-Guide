...
export const metadata = {
  title: "Structured Output — CCA Study Guide",
}

export default async function StructuredOutputPage() {
  const mdx = getMdxContent("domain-4/structured-output")
  if (!mdx) notFound()
  ...
  return (
    <TopicLayout
      ...
      prev={{ title: "Few-Shot Prompting", href: "/study/domain-4/few-shot-prompting" }}
      next={{ title: "Validation & Retry", href: "/study/domain-4/validation-retry" }}
    >
      {content}
    </TopicLayout>
  )
