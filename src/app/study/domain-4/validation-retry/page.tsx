...
export const metadata = {
  title: "Validation & Retry — CCA Study Guide",
}

export default async function ValidationRetryPage() {
  const mdx = getMdxContent("domain-4/validation-retry")
  if (!mdx) notFound()
  ...
  return (
    <TopicLayout
      ...
      prev={{ title: "Structured Output", href: "/study/domain-4/structured-output" }}
      next={{ title: "Batch API", href: "/study/domain-4/batch-api" }}
    >
      {content}
    </TopicLayout>
  )
