...
export const metadata = {
  title: "Batch API — CCA Study Guide",
}

export default async function BatchApiPage() {
  const mdx = getMdxContent("domain-4/batch-api")
  if (!mdx) notFound()
  ...
  return (
    <TopicLayout
      ...
      prev={{ title: "Validation & Retry", href: "/study/domain-4/validation-retry" }}
      next={{ title: "Prompt Caching", href: "/study/domain-4/prompt-caching" }}
    >
      {content}
    </TopicLayout>
  )
